...
from .commands import analyse, chat, config, portfolio, screen, universe
...
app.add_typer(chat.app, name="chat", help="Persistent multi-turn chat about the market and your portfolio.")
